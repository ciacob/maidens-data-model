package ro.ciacob.maidens.legacy.editor.nudge {
...
public class ClusterNudgingTools {
     ...
     * (ii) regular right nudge of the last Cluster of an underfull Voice ("underfull" here meaning it has Clusters
     * that do not amount to the needed musical duration of the parent Measure).
