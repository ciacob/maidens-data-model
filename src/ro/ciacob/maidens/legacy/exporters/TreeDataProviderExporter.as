...
import eu.claudius.iacob.maidens.constants.TreeFieldNames;
...
public class TreeDataProviderExporter implements IExporter {
    ...
    private static function _onElementLabelReady(data:Object):void {
    ...
    private static function _compareVoiceChildren(operandA:Object, operandB:Object):int {
    ...
    private function _stampPartsScoreOrder(item:Object, index:int, ignore:Array):void {
