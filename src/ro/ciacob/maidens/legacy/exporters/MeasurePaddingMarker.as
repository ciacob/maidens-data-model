package ro.ciacob.maidens.legacy.exporters {
    ...
    public class MeasurePaddingMarker implements IABCMarker {
         ...
         * ABC markup with invisible rests to that amount, and returns it. Returns an
        ...
        private function _queryVoiceData():void {
            ...
            _measureNumber = queryEngine.uidToMeasureNumber(measure.route);
            _voiceDuration = queryEngine.computeVoiceDuration(_voice as ProjectData);
            _measureSpan = queryEngine.computeMeasureSpan(measure as ProjectData);
        }
    }
}
