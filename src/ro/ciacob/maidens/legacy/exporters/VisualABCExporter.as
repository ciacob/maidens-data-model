...
public class VisualABCExporter extends BaseABCExporter {
    ...
    /**
     * Temporary local storage for the `project` argument received by overridden method `export()`.
     */
    private static var _project:DataElement;

    /**
     * Temporary local storage for the `partData` argument received by overridden method `buildStaffHeaderData()`.
     */
    ...
    /**
     * Temporary local storage for the `target` argument received by overridden method `buildStaffHeaderData()`.
     */
    ...
    /**
     * Overridden to add support for brackets, braces, and grouping (reflected in the
    ...
    override protected function buildStaffHeaderData(partData:Object, target:Object, staffIndex:int):void {
        ...
        // Some staves must have "hidden" names, which is problematic at its best; We'll use our own fields
