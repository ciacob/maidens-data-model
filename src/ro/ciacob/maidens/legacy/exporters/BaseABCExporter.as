...
public class BaseABCExporter implements IExporter {
     ...
     *
     * @param    staffIndex
     *            The zero-based index of this staff, which will be included in the
     ...
     * treated literally in the context of a string.
     *
     ...
     * You can overwrite it to amend the translation, e.g., by inserting an annotation
